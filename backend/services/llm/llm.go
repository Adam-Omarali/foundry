...
func (s *LLMService) GenerateText(ctx context.Context, prompt string) (string, error) {
	prompt += " Please summarize the following text in a concise manner. This summary will be used to create an embedding for the document. The goal is to make the content indexable and searchable with fuzzy search."
